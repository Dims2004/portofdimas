      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 pb-16 pt-20 sm:px-10 sm:pt-28 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
        <Reveal>
          ...
          {work.link && (
              ...
              className="mt-8 inline-flex items-center gap-2 text-sm text-accent-2 transition-colors hover:text-accent"
            >
              {lang === "id" ? "Lihat kode di GitHub" : "View code on GitHub"}
